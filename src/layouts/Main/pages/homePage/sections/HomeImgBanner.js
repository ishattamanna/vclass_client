...
import homeBannerImg from '../../../../../assets/home_images/HomeBannerImg.jpeg'
import OutlineButton from '../../../../../tools/buttons/OutlineButton';
import ArrowDownIcon from '../../../../../tools/icons/ArrowDownIcon';

const HomeImgBanner = () => {
    return (
        <div className="hero h-[90vh] lg:h-[70vh] mb-5 rounded-lg" style={{ backgroundImage: `url(${homeBannerImg})` }}>
            ...
            <div className="hero-content text-center text-neutral-content">
                <div className="max-w-md">
                    ...
                    <ArrowDownIcon className={"font-bold mx-auto mt-5 animate-bounce lg:hidden"}></ArrowDownIcon>
                </div>
            </div>
        </div>
    );
